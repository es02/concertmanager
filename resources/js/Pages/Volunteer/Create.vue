...
function createVolunteer() {
    router.post('/volunteer/create', form);
};
...
<template>
    <AppLayout title="Create Volunteer">
      <template #header>
      ...
      <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
            <form @submit.prevent="createVolunteer">
                <input
                    id="photo"
                    ref="photoInput"
                    type="file"
                ...
                <div class="mb-4">
                    <button type="submit" @click="createVolunteer()" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create Volunteer</button>
                </div>
            </form>
          </div>
        </div>
